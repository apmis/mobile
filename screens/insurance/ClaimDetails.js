...
export default function ClaimDetails() {
  ...
  return (
    <View style={{ backgroundColor: "#F3F3F3", flex: 1 }}>
      <Bar hideBar={false} />
      <UpperNavigation back title="Claim Details" />
      ...
      <View style={{ flex: 1, width: windowWidth - 40, marginHorizontal: 20, paddingTop: 20 }}>
        ...
        <View style={{marginTop: 24}}>
          <AppText style={{color: "#0E214D", fontSize: 16, fontWeight: "700"}}>Capitation:</AppText>
          <AppText style={{color: "#6D7589", fontSize: 16, fontWeight: "400", marginTop: 5}}>Filed</AppText>
        </View>
      </View>
    </View>
  );
